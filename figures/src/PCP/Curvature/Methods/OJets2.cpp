...
PointWiseEstimationData CurvatureComputer_OJets2::compute(const Geometry& points, int i, Scalar r) const
{
    ...
    in_points.push_back(DPoint(points[i].x(), points[i].y(), points[i].z()));
